...
supported argument:
    ...
    -process-video-randomize [true|false] : randomize the order of photos in the sequenced video (defaults to false)
    ...
    if(Args.getArg('-process-images', 'true') !== 'false') {
        ...
        Process.processImages(inputPath, randomize === 'true');
    }
    else {
